export function Services() {
  return (
    <section
      id="services"
      className="flex flex-col justify-center min-h-screen bg-whitesmoke dark:bg-black-121212"
    >
      <div className="container px-4 mx-auto text-center pt-28 xl:px-0 sm:pt-0">
