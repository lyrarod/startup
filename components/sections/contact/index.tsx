export const Contact = () => {
  return (
    <section
      id="contact"
      className="relative z-10 flex items-center justify-center w-full min-h-screen overflow-hidden"
    >
      <div className="container px-4 pb-20 pt-28 lg:pb-0">
        <div className="flex flex-wrap -mx-4 lg:justify-between">
          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div className="relative p-8 bg-white rounded-lg shadow-lg dark:bg-black-202023 sm:p-12">
              <form>
                <ContactInputBox
                  type="text"
                  name="name"
